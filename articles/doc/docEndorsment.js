...
<div class="article-content doc-endorsement-initiator active-article-content">
    ...
    <div class="detail-content">
        <ol>
            ...
            <li>Выберите пользователей на роли <a href =''>Согласующий, Утверждающий, Секретарь</a></li>
            <li>Для роли согласующий возможно выбрать несколько пользователей, использовав <a href =''>множественное назначение</a> </li>
    ...
    <div class="detail-content">
        В случае если участником процесса карточка было отклонена, она возвращается инициатору
    ...
    <div class="detail-content">
        После запуска процесса Инициатор может поменять участнико (если включена функция Изменения участников).
        <ol>
...
<details>
<summary class='detail-title'>
    Как согласовать/отправить на доработку
</summary>
<div class="detail-content">
...
<details>
<summary class='detail-title'>
    Как утвердить/отправить на доработку
</summary>
<div class="detail-content">
    Вы можете выполнить процессное действие из карточки документа, нажав соответствующую кнопку:
    <ul>
        <li>Утвердить - документ утвержден, процесс завершается. Если в процессе учавствует секретарь, карточка переходит к нему на регистрацию. По желанию можно оставить комментарий.</li>
        <li>Отклонить - документ возвращается на доработку инициатору, процесс начнется с начала. Необходимо в комментарии указать причину.</li>
    </ul>
    Данные действия также доступны из <a href="">списка</a>документов, по нажатию на "состояние" и при просмотре вложений.
</div>
</details>
